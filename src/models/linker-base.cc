...
vector<string> GCCModelGenerator::parse_linker_output(
  const vector<string>& linker_args )
{
  istringstream linker_output { run(
    linker_args.front(), linker_args, {}, true, true, true, true ) };
