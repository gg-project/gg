...
public:
  ...
  void ezwrite( std::string&& msg )
  {
    write_buffer_.emplace_back( move( msg ) );
  }
  ...
  {
    return ( state_ != State::needs_connect )
           and ( state_ != State::needs_ssl_read_to_connect )
           and ( state_ != State::needs_ssl_write_to_connect );
  }

  bool accepted() const
  {
    return ( state_ != State::needs_accept )
           and ( state_ != State::needs_ssl_read_to_accept )
           and ( state_ != State::needs_ssl_write_to_accept );
  }
};
